using LeagueTracker.Domain.Events;
using Microsoft.Extensions.Logging;

namespace LeagueTracker.Application.TodoItems.EventHandlers;
...
public class LogTodoItemCompleted : INotificationHandler<TodoItemCompletedEvent>
{
    ...
    {
        _logger.LogInformation("LeagueTracker Domain Event: {DomainEvent}", notification.GetType().Name);
