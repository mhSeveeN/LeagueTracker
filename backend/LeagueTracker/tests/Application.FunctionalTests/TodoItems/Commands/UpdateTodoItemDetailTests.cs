using LeagueTracker.Application.TodoItems.Commands.CreateTodoItem;
using LeagueTracker.Application.TodoItems.Commands.UpdateTodoItem;
using LeagueTracker.Application.TodoItems.Commands.UpdateTodoItemDetail;
using LeagueTracker.Application.TodoLists.Commands.CreateTodoList;
using LeagueTracker.Domain.Entities;
using LeagueTracker.Domain.Enums;

namespace LeagueTracker.Application.FunctionalTests.TodoItems.Commands;
